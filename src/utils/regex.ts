export const shouldHaveInTitle: RegExp =
...
export const shouldExcludeIftitle: RegExp =
  /\b(senior|sr.|lead|principal|director|manager|intern|internship|quantitative|android|sharepoint|kotlin|drupal|365|d365|azure|lavarel|architect|php|power|powerapps|powerapp|spring|golang|dotnet|rust|salesforce|java|appian|csharp|c#)\b/i;
