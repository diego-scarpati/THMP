...
export const shouldExcludeIftitle =
  /\b(senior|lead|principal|director|manager|intern|internship|android|kotlin|drupal|365|d365|azure|lavarel|architect|php|power|powerapps|powerapp|spring|golang|dotnet|rust|salesforce|java|appian|csharp|c#)\b/i;
