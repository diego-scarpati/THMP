...
export const shouldExcludeIftitle =
  /\b(senior|lead|principal|director|manager|intern|internship|drupal|365|lavarel|architect|php|power|powerapps|powerapp|spring|swift|golang|dotnet|rust|salesforce|java|appian|csharp)\b/i;
