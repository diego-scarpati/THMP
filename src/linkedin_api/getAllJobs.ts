...
export const getAllJobs = async (getAllJobsParamObject: GetAllJobsParams): Promise<any> => {
  const { keywords, locationId, datePosted, sort, start, experienceLevel } = getAllJobsParamObject;
